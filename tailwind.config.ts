  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "footer-gradient": "linear-gradient(-363deg, #4C1D95 -51.52%, #5B21B6 -5.15%, #010101 100%)",
        "footer-join-more-gradient": "linear-gradient(-363deg, #4C1D95 -51.52%, #5B21B6 -5.15%, #010101 100%)",
