    ...
    <Masonry items={testimonials} bind:gridGap colWidth={`minmax(Min(20.938em, 100%), 1fr)`} stretchFirst={false} reset>
      {#each testimonials as testimonial}
        {#if showDialog}
          <Dialog.Root>
            <Dialog.Trigger>
              <div class="break-inside-avoid rounded-[1rem] border bg-[#F9F9F9] p-4 font-geist hover:border-violet-700">
                  ...
                  <div class="w-full text-left">
                    ...
                    <div class="flex w-full items-center">
                      ...
                      {#if testimonial.position.length > 24}
                        <HoverCard.Root>
                          <HoverCard.Trigger>
                            <h3 class="w-full truncate font-geist text-[14px] font-light leading-[120%] text-[#737275]">
            ...
            <div class="flex gap-x-[0.5rem]">
              ...
              <div class="w-full text-left">
                ...
                <div class="flex w-full items-center">
                  ...
                  {:else}
                    <h3 class="text-nowrap font-geist text-[14px] font-light leading-[120%] text-[#737275]">
                      {testimonial.companyName}
                    </h3>
                  {/if}
                  <Dot class="text-[#737275]" />
