...
<div
  ...
  <div class="col-span-1 md:col-span-5">
    <div class="flex flex-col items-center md:items-start">
      <div>
        <SectionIconAndName 
        sectionTitleClass="mb-[1.5rem]" sectionIcon={props?.sectionIcon} sectionName={props?.sectionTitle} sectionTitle={props?.title} />
      </div>
      <h2 class="text-[#5B6779] font-normal [mb-[1.88rem] text-center text-[1.125rem] md:text-left">
        {props.description}
      </h2>
    </div>
  </div>
