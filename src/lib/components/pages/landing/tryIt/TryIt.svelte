		...
		<div class="relative z-10 h-fit w-full px-5 pb-6 pt-[52px] lg:px-[50px] lg:py-[40px]">
			...
			<form class="mt-6 flex" method="POST" use:enhance>
				<div class="flex w-full flex-col gap-4 md:flex-row md:flex-wrap">
					<div class="w-full sm:max-w-[283px]">
								...
								{#snippet children({ props })}
									<div class="relative w-full">
										<Input
											...
											class="min-h-[3.5rem] w-full rounded-[0.75rem] bg-white pl-[2.3rem] text-[1.25rem] md:min-h-[3.75rem] md:pl-[2.6rem]"
										/>
								...
								{#snippet children({ props })}
									<div class="relative w-full">
										<Input
											...
											class="min-h-[3.5rem] w-full rounded-[0.75rem] bg-white pl-[2.4rem] text-[1.25rem] md:min-h-[3.75rem] md:pl-[2.7rem]"
										/>
									...
									{#snippet children({ props })}
										<div class="relative w-full">
											<Input
												...
												class="w-full rounded-md bg-transparent px-3 py-[0.2rem] text-[1.25rem] text-black file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground
					...
					<Form.Button
						class="flex h-fit min-h-[3.5rem] w-full min-w-[17.38rem] items-center justify-center gap-3 rounded-[0.75rem] bg-primary-gradient px-8 py-4 font-geist text-[18px]
            font-normal leading-[18px] tracking-normal text-white sm:max-w-[283px] md:min-h-[3.75rem]"
					>
						<SanityImage
							class="h-5 w-5"
...
<!-- <div class="relative">
	<div
		class="mx-[1.25rem] rounded-[1.875rem] bg-footer-gradient md:mx-auto lg:-top-[9rem] lg:bg-footer-gradient lg:pb-0 xl:w-fit"
	>
		<div
				...
				<div class="mt-[1.5rem] h-full w-full md:mt-[2rem]">
					...
					>
						...
						>
							...
							<div class="col-span-1">
								<div class="relative h-full min-h-[3.5rem] w-full md:min-h-[3.75rem]">
									<div
                  ...
                  "
                                        ...
                                        placeholder:text-muted-foreground focus-visible:outline-none md:max-w-[150px] lg:max-w-[150px]"
															/>
														</div>
													{/snippet}
												</Form.Control>
