<script lang="ts">
  ...
  let { sectionIcon, sectionName, sectionTitle, description, stats } = $derived(securedAndEfficient);
...
<div class="mx-auto mb-[3.75rem] max-w-7xl px-5 2xl:px-0">
  <div class={cn("mt-10 flex h-fit w-fit rounded-full", "border border-gray-200 p-px max-lg:mx-auto md:mt-24")}>
  ...
  <div class="mt-6 flex flex-col gap-x-[2.5rem] gap-y-8 max-lg:items-center lg:flex-row lg:justify-between">
