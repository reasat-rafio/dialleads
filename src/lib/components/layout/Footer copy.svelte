...
<div class="  relative flex max-w-full flex-col justify-center md:h-[32.4rem]">
  ...
  <div class="container z-50 mx-auto gap-x-[6.56rem] pt-[9.78rem]">
    <div class="grid grid-cols-12">
      ...
      <div class="col-span-6">
        <div class="grid grid-cols-3 gap-x-[3.75rem]">
          <div class="col-span-1 border-r-[0.1rem] border-[#E4E4E733]">
            <h2
...
<div class="relative h-full w-full">
  <div class="absolute top-[-7rem] z-50 w-full">
    <div class="container relative">
      <div
        class="max-h-[27.37rem] overflow-hidden rounded-[1.88rem] md:max-h-[13rem]">
        <SanityImage
          class="  w-full  rounded-[1.88rem]  object-contain"
          src={footer?.backgroundOne}
          sizes="30vw"
          imageUrlBuilder={imgBuilder} />
      </div>
...
<div
  class="  relative flex h-full max-w-full flex-col justify-center md:h-full">
  <div
    style="background: linear-gradient(19deg, #4C1D95 11.11%, #5B21B6 43.75%, #212121 95.69%);"
    class="h-full">
    <div class="container z-50 mx-auto h-full gap-x-[6.56rem] pt-[9.78rem]">
