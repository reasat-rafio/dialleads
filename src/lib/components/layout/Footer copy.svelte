...
<div class="relative mt-[250px] hidden h-full w-full lg:block">
  <div class="absolute top-[-12rem] z-50 w-full lg:top-[-7rem]">
    <div class="container relative">
      ...
      <div
        ...
        <h2
          class="col-span-6 h-fit border pr-[3rem] text-[1.625rem] font-semibold text-white lg:col-span-4 xl:col-span-5 xl:text-[2.625rem]">
          {footer.title}
        </h2>
        <div
